"""Legacy CLI compatibility exports.

Command implementations have moved into focused ``commands/*.py`` modules.
This module remains as the ``distill._cli_impl`` compatibility target while
old private imports are repointed to canonical owners.
"""
...
from distill.commands._helpers import (
    ...
    get_config,  # noqa: F401 - compatibility export for distill._cli_impl
)
from distill.commands._helpers import (
