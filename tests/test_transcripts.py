...
from distill.transcripts import (
    _try_scribe,
...
class TestGetTranscript:
    @patch("distill.transcripts._try_youtube_captions")
    ...
    @patch("distill.transcripts._try_scribe")
    @patch("distill.transcripts._try_youtube_captions")
...
class TestYoutubeCaptionsFallback:
    @patch("distill.transcripts.yt_dlp.YoutubeDL")
    ...
    @patch("distill.transcripts.tempfile.TemporaryDirectory")
    @patch("distill.transcripts.yt_dlp.YoutubeDL")
...
class TestScribeFallback:
    ...
    @patch("distill.transcripts.subprocess.run")
    ...
    @patch("distill.transcripts.subprocess.run", side_effect=TimeoutError())
    ...
    @patch(
        "distill.transcripts.subprocess.run",
