...
Shipped: **0.1 through 0.19** (latest release 0.19.47, 2026-07-31). Per-release detail is the changelog's job, not the roadmap's: [`docs/CHANGELOG.md`](docs/CHANGELOG.md). Newest-first headlines:
