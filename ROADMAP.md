...
Previously shipped: **0.1 through 0.8.2** (initial release, internal foundations, MCP-first surface, local inference, living wiki, synthesis-quality patch, concept playbook, frontmatter-field rename, playbook recovery surface). Per-release detail lives in [`docs/CHANGELOG.md`](docs/CHANGELOG.md).
