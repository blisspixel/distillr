...
review. The active `0.20.1` boundary closes billing and interoperability
...
| `0.20.1` | active | local-inference billing proof, MCP and Agent Plugins compatibility, bounded API pacing, release evidence |
