...
uv run pytest --cov=distill --cov-fail-under=92   # branch coverage gate
```
...
uv run pytest --cov=distill --cov-fail-under=92               # branch coverage stays above the floor
...
uv run pytest -q --cov=distill --cov-fail-under=92
